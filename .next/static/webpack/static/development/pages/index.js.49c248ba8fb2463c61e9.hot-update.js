  ...
  function PostFeed() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleToggleLike", function (post) {
      ...
      sendRequest(post._id).then(function (postData) {
        ...
        var updatedPosts = [].concat(_toConsumableArray(_this.state.posts.slice(0, postIndex)), _toConsumableArray(_this.state.posts.splice(postIndex + 1)));
      });
    });
...
//# sourceMappingURL=index.js.49c248ba8fb2463c61e9.hot-update.js.map