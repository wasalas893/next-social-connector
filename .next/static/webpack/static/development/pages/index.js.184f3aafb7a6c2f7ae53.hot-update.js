  ...
  function UserFeed() {
    ...
    _defineProperty(_assertThisInitialized(_this), "handleFollow", function (user, userIndex) {
      Object(_lib_api__WEBPACK_IMPORTED_MODULE_15__["followUser"])(user._id).then(function (user) {
        var updatedUsers = [].concat(_toConsumableArray(_this.state.users.slice(0, userIndex)), _toConsumableArray(_this.state.user));
      });
    });
...
//# sourceMappingURL=index.js.184f3aafb7a6c2f7ae53.hot-update.js.map